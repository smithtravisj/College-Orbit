          ...
          <div style={{ paddingTop: '8px', display: 'flex', gap: '10px' }}>
            ...
            <button
              ...
              style={{
                ...
                justifyContent: 'center',
                background: '#27272a',
                border: `1px solid ${collegeButtonColor ? collegeButtonColor + '40' : '#3f3f46'}`,
                borderRadius: '12px',
                cursor: loading ? 'not-allowed' : 'pointer',
                opacity: loading ? 0.5 : 1,
                transition: 'background 0.2s, border-color 0.2s',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = '#3f3f46'; e.currentTarget.style.borderColor = collegeButtonColor ? collegeButtonColor + '60' : '#52525b'; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = '#27272a'; e.currentTarget.style.borderColor = collegeButtonColor ? collegeButtonColor + '40' : '#3f3f46'; }}
