...
const faqData: FAQ[] = [
  ...
  // Additional Tools
  {
    ...
    answer: 'Create flashcard decks from the Tools page. Add cards with questions and answers. Study using spaced repetition which prioritizes cards you struggle with. Track your progress over time.',
    category: 'Tools',
    keywords: ['flashcard', 'study', 'memorize', 'cards', 'deck'],
  },
  {
    id: 'citation-generator',
    question: 'How does the citation generator work?',
    answer: 'Enter a URL, DOI, ISBN, or manually input source details. Choose your citation style (APA, MLA, Chicago, etc.) and generate properly formatted citations. Copy to clipboard or save for later.',
    category: 'Tools',
    keywords: ['citation', 'reference', 'bibliography', 'apa', 'mla'],
  },
  {
    id: 'word-counter',
    question: 'Where is the word counter?',
    answer: 'The word counter is built into the notes editor - view the word count at the bottom of any note. You can also use the standalone word counter tool to paste any text and get detailed stats.',
    category: 'Tools',
    keywords: ['word', 'count', 'counter', 'length', 'characters'],
  },
  {
    id: 'unit-converter',
    question: 'Is there a unit converter?',
    answer: 'Yes, the unit converter in Tools handles common conversions: length, weight, temperature, volume, and more. Great for science and engineering courses that use different unit systems.',
    category: 'Tools',
